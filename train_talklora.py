...
from models.get_models import print_trainable_parameters, get_tokenizer, get_prefix_tuning_models, get_talklora_models, get_fft_models
import argparse
from customized_trainer import customized_trainer

parser = argparse.ArgumentParser()
parser.add_argument('--peft_type', type=str,
                    choices=['prefix', 'talklora', 'fft'])
...
parser.add_argument('--output_folder', type=str, default='results_talklora')
...
if peft_type == 'talklora':
    ...
    model, tokenizer, model_config = get_talklora_models(load_bit=args.load_bit,
...
if tokenizer_left.pad_token_id is None and 'llama3' in model_name.lower():
